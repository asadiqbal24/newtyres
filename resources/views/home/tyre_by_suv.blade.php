...
<body class="no-js">
 ...
 -->
                                            ...
                                            <a class="productButton" href="{{route('buy/tyre',['brand'=>$ty->tyre_brands->url,'pattern'=>$ty->tyre_pattern->url,'tyre'=>$ty->url])}}" data-id="142281" data-brand="{{$ty->tyre_brands->name}}" data-pattern="{{$ty->tyre_pattern->name}}" data-tyresize="{{$ty->name}}" data-tyretypeid="1">{{$ty->name}}</a>
                                            ...
                                            <div class="price">
                                                    <div class="rrp-outer" style="height: initial;">
                                                            <div class="price-was-outer">
                                                                <div class="price-was">
                                                                    Was <span class="wasPrice">267</span>
                                                                </div>
                                                            </div>
                                                    </div>
...
<div class="getHelpForm">
                ...
                <div class="search-link">
                    <h1 style="font-size:24px;color:#ee8000;font-weight:bold;padding:0 0 15px 20px;">SUV Tyres</h1>
                    @foreach($runbrands as $run)
                        @if($run->suv_tyres->count() > 0)
                        <h2>
                            <a href="{{route('tyres/suv',['slug'=>$run->url])}}">{{$run->name}}</a>
                        </h2>

                        <ul class="search-tyre-size-links">
                            @foreach($run->suv_tyres as $r)
                                <li style="padding-right:20px">
                                      <a href="{{route('suv/view/tyre',['slug'=>$r->url])}}">{{$r->name}}</a>  
                                </li>
                            @endforeach 
                        </ul>
                        @endif
