...
<style>
    ...
    <!--        <a {{route('home')}} title="tyresales proudly part of carsales" style="height:62px; display:inline-block;">-->

    <!--            <img alt="tyresales proudly part of carsales" src="{{asset('public/front/vehicles/images/Tyresales_LockupCarsales_Horizontal_grey.png')}}" style="height:62px !important;" /></a>-->
 ...
 @include('front.default.header')
        ...
        <div role="main">
            ...
            <div class="content feedback" id="content">
                ...
                <!--        <img alt="Tyresales" src="{{asset('public/front/vehicles/images/Tyresales_Blue_WebVersion.png')}}" style="max-height:100%;" />-->
                <!--    </a>-->
                <!--    <img alt="Proudly part of carsales" src="{{asset('public/front/vehicles/images/PartOfCarsales_Lockup_grey.png')}}" style="max-height: 100%; float: right;" />-->
                <!--</header>-->
                ...
                <article class="clearfix">
                    ...
                    <section>
                        ...
                        <ul class="breadcrumbs clearfix" vocab="http://schema.org/" typeof="BreadcrumbList">
                            ...
                            <li property="itemListElement" typeof="ListItem" class=""><a property="item" typeof="WebPage" class="last-breadcrumb"><span property="name">Otr</span></a>
                        ...
                        <div class="searchMod clearfix">
                            <ul class="tabNavigation clearfix mainSearch">
                                <li class="searchAgainBy">Search Otr again by:</li>
                                <li><a class="selected" id="size_div" href="#searchSizeDiv">Size</a></li>

                                <li><a class="" id="brands_div" href="#searchBrandDiv">Brand</a></li>
                            </ul>

                            <div id="searchSizeDiv" class="tab" style="height:76px;">
                                
                                <form method="get" action="{{route('otr/search')}}">
                                
                                <input type="hidden" name="ctl00$ctl00$defaultContent$searchContainer$searchSize$doSizeSearch" id="doSizeSearch" value="false" />
                                <div class="searchRow searchRowTruckSize">
                                    <span class="searchTabSubheading">Your OTR tyre size:</span>
                                    ...
                                    <div class="searchSelect profile">
                                        <label for="defaultContent_searchContainer_searchSize_ddlOtrTraCode">TRA Code *</label>
                                                <select name="tra_code" id="tra_code" class="ddlOtrTraCode">
                                                    <option value="">TRA Code</option>
                                ...
                                <div class="searchRow advancedHidden advancedSizeSearch">
                                    ...
                                    <span class="searchTabSubheading">Optional details:</span>
                                            <div class="searchSelect" style="width: 110px;">
                                                <select name="attributes" id="defaultContent_searchContainer_searchSize_ddlOtrSpecification" class="ddlOtrSpecification">
                                            <option value="{{NULL}}">Specification</option>
                                            <option value="1">Heat Resistant</option>
                                            <option value="2">Cut Resistant</option>
                                            ...
                                            <span class="faq"><img src="{{asset('public/front/vehicles/images/qmark.png')}}" alt="help">
                                                <div class="helpText">
                                                    <p>Tyre Specification (Heat resistant, Cust resistant, Standard).</p>
                            ...
                            <div id="searchBrandDiv" class="tab" style="display:none">
                                <form method="get" action="{{route('otr/search')}}">                                    
                                <input type="hidden" name="ctl00$ctl00$defaultContent$searchContainer$searchBrand$doBrandSearch" id="doBrandSearch" value="false" />
                                <div class="searchRow">
                                ...
                                <div class="searchRow">
                                    ...
                                    <div class="searchSelect profile">
                                        ...
                                        <select name="ratio" id="defaultContent_searchContainer_searchBrand_ddlTruckBrandAspectRatio" class="ddlTruckBrandAspectRatio">
                                            <option value="">Profile</option>
                                    ...
                                    <div class="searchSelect profile">
                                        <label for="defaultContent_searchContainer_searchSize_ddlOtrTraCode">TRA Code *</label>
                                                <select name="tra_code" id="defaultContent_searchContainer_searchSize_ddlOtrTraCode" class="ddlOtrTraCode">
                                                    <option value="">TRA Code</option>
                                ...
                                <div class="searchRow advancedHidden advancedBrandSearch">
                                    ...
                                    <span class="searchTabSubheading">Optional details:</span>
                                       <div class="searchSelect">
                                            <select name="attributes" id="defaultContent_searchContainer_searchBrand_ddlOtrBrandSpecification" class="ddlOtrBrandSpecification">
                            ...
                            <div class="resultsMod">
                                ...
                                <img alt="Save up to $100 with Free Shipping to metro areas for limited time only!" src="{{asset('public/front/vehicles/images/freeShipping.jpg')}}" class="freeShipping" />
                        ...
                        <div class="search-link">
                            <div>
                                ...
                                <div>
                                    ...
                                    @if($cat->otr_tyres->count() > 0)
                                    <h2>{{$cat->name}} tyres: </h2>
                                    <ul class="search-tyre-size-links">
                                        @foreach($cat->otr_tyres as $tyre)
                                        <li><a href="{{route('otr/size',['slug'=>$tyre->url])}}">{{$tyre->name}}</a></li>
                                        @endforeach
                                    </ul>
                                    @endif
                                    @endforeach
  ...
  headers: {
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      ...
      $('#defaultContent_searchContainer_searchSize_ddlTruckAspectRatio').change(function(){
        ...
        $.ajax({
                type:'POST',
                url:'{{route("get_tra_code")}}',
                data:{_token: "{{ csrf_token() }}",val:val
                },
                success: function( msg ) {
                    var x = '<option value="NULL">Tra Code</option>';
                    for(i=0;i<msg.length;i++){
                        if(msg[i].tra_code!=null){
                        if(i==0){
                            x += '<option value="'+msg[i].tra_code+'" class="sc-esjQYD iBqqkR">'+msg[i].tra_code+'</option>';
                        }else{
                            x += '<option value="'+msg[i].tra_code+'" class="sc-esjQYD iBqqkR">'+msg[i].tra_code+'</option>';
                        }
                      }
                    ...
                    if(x!=-1){
                        $('.ddlOtrTraCode').removeAttr('disabled');
                        $('.ddlOtrTraCode').html(x);
                    }
