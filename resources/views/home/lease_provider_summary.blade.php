            ...
            <div class="sc-ccXozh kgmAjN">
                ...
                <div class="sc-fAJaQT kAQPpu">
                    <div class="sc-cNnxps buOJrx">
                                                ...
                                                <p class="sc-dnqmqq sc-dPPMrM hYOYCP">You have selected to pay via lease provider, please use the following details and the instructions below:</p>
                        <div class="sc-jWxkHr jMFYKC">
                            <div class="sc-imDfJI jecWAD">Lease Finance Provider :</div>
                            <div class="sc-hAnkBK kFiTya">{{$provider->name}}</div>
                        </div>
                        <div class="sc-jWxkHr jMFYKC">
                            <div class="sc-imDfJI jecWAD">Lease Finance Provider Email :</div>
                            <div class="sc-hAnkBK kFiTya">{{$provider->email}}</div>
                        </div>
