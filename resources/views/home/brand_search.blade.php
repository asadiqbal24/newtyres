            ...
            <div id="body">
                ...
                <div class="content">
                    <section class="content-wrapper main-content clear-fix gtm-event-target" data-gtm-event-trigger="PageView" data-gtm-event-body="{&quot;event&quot;:&quot;tyreSearch&quot;,&quot;ecommerce&quot;:{&quot;impressions&quot;:[{&quot;id&quot;:&quot;142281&quot;,&quot;name&quot;:&quot;NT860&quot;,&quot;price&quot;:&quot;108.00&quot;,&quot;item_price&quot;:&quot;108.00&quot;,&quot;category&quot;:&quot;Passenger&quot;,&quot;brand&quot;:&quot;NITTO&quot;,&quot;Is4WD&quot;:&quot;4x2&quot;,&quot;currency&quot;:&quot;AUD&quot;,&quot;variant&quot;:&quot;185/65R15 88V&quot;,&quot;list&quot;:&quot;Full 2010 Alfa Romeo 147 Tyre Prices&quot;,&quot;position&quot;:1},{&quot;id&quot;:&quot;105898&quot;,&quot;name&quot;:&quot;ASSURANCE FUELMAX&quot;,&quot;price&quot;:&quot;129.00&quot;,&quot;item_price&quot;:&quot;129.00&quot;,&quot;category&quot;:&quot;Passenger&quot;,&quot;brand&quot;:&quot;GOODYEAR&quot;,&quot;Is4WD&quot;:&quot;4x2&quot;,&quot;currency&quot;:&quot;AUD&quot;,&quot;variant&quot;:&quot;185/65R15 88V&quot;,&quot;list&quot;:&quot;Full 2010 Alfa Romeo 147 Tyre Prices&quot;,&quot;position&quot;:2}]},&quot;currencyCode&quot;:&quot;AUD&quot;}">
                        ...
                        <form action="{{route('vehicle/search')}}" class="search-form" method="get" id="searchMethod">
        ...
        <div class="helpText">
            ...
            <p><a href="/help/load-and-speed-index-tables"><img src="{{asset('public/front/vehicles/images/speedindex_info.jpg?sfvrsn=2')}}" alt="Tyre Speed Index" title="SpeedIndex_info" /><br />
                                        ...
                                        <div class="searchSelect brand">
                                            ...
                                            <select class="ddlBrand" id="ddlBrand" name="brand">
                                                ...
                                                @foreach($brands as $br)
                                                    @if($brnd==$br->url)
                                                    <option selected="selected" value="{{$br->url}}">{{$br->name}}</option>
                                                    @else
                            ...
                            <div class="searchResults">
                                <h1 class="resultsInfo">{{$brnd}} Tyre Prices</h1>
                            </div>
                        ...
                        <div class="tyrePanels">
                                ...
                                <div class="tyrePanel_GBB ">
                                    ...
                                    <div id="tyrePanel_142281" class="tyrePanel getQuote" style="opacity: <?php if($ty->stock_available > 0) echo 1; else echo 0.45 ?>;" data-gtm-event-body="{&quot;event&quot;:&quot;productClick&quot;,&quot;ecommerce&quot;:{&quot;click&quot;:{&quot;actionField&quot;:{&quot;list&quot;:&quot;Full 2010 Alfa Romeo 147 Tyre Prices&quot;},&quot;products&quot;:[{&quot;id&quot;:&quot;142281&quot;,&quot;name&quot;:&quot;NT860&quot;,&quot;price&quot;:&quot;108.00&quot;,&quot;item_price&quot;:&quot;108.00&quot;,&quot;category&quot;:&quot;Passenger&quot;,&quot;brand&quot;:&quot;NITTO&quot;,&quot;Is4WD&quot;:&quot;4x2&quot;,&quot;currency&quot;:&quot;AUD&quot;,&quot;variant&quot;:&quot;185/65R15 88V&quot;,&quot;list&quot;:&quot;Full 2010 Alfa Romeo 147 Tyre Prices&quot;,&quot;position&quot;:1}]}},&quot;currencyCode&quot;:&quot;AUD&quot;}">
                                        ...
                                        <div class="logo">
                                            <img src="{{$ty->tyre_brands->image}}" alt="{{$ty->tyre_brands->name}}" style="width: 50px">
                                        </div>
                                        ...
                                        <div class="tyreName">
                                            ...
                                            <a class="productButton" href="{{route('buy/tyre',['brand'=>$ty->tyre_brands->url,'pattern'=>$ty->tyre_pattern->url,'tyre'=>$ty->url,'id'=>$ty->id])}}" data-id="142281" data-brand="{{$ty->tyre_brands->name}}" data-pattern="{{$ty->tyre_pattern->name}}" data-tyresize="{{$ty->name}}" data-tyretypeid="1">{{$ty->name}}</a>
                                            
                                            @else

                                            <a class="productButton" href="#" data-id="142281" data-brand="{{$ty->tyre_brands->name}}" data-pattern="{{$ty->tyre_pattern->name}}" data-tyresize="{{$ty->name}}" data-tyretypeid="1">{{$ty->name}}</a>
                                        ...
                                        @endif
                                            ...
                                            <div class="buyPanel">
                                                        ...
                                                        <div class="tyreProduct">
                                                            ...
                                                            href="{{route('buy/tyre',['brand'=>$ty->tyre_brands->url,'pattern'=>$ty->tyre_pattern->url,'tyre'=>$ty->url,'id'=>$ty->id])}}" data-id="155884" data-brand="GOODYEAR" data-pattern="EAGLE EFFICIENT GRIP PERFORMANCE" data-tyresize="205/60R16 92V" data-tyretypeid="1">View</a>
                                                        </div>
                                                    </div>                                        
                                            @endif 
                        ...
                        <div class="paginationButtons">
                            @php $params = array('brands' => $brnd, 'pattern' => $ptrn); @endphp
                            {{$tyres->appends($params)->links()}}
                        ...
                        <div>
                            ...
                            <div class="search-filter">
                                        ...
                                        <div class="list-categories">
                                            ...
                                            <div>
                                                <label>
                                                    ...
                                                    <input type="checkbox" class="categories_list" name="categories_sel[]" checked="checked" value="{{$attr->id}}" />
                                                             @else
                                                             
                                                    <input type="checkbox" class="categories_list" name="categories_sel[]" value="{{$attr->id}}" />
                                                             @endif   
                                                    @else
                                                    <input type="checkbox" class="categories_list" name="categories_sel[]" value="{{$attr->id}}" />
                                                    @endif
                                ...
                                <div class="center-button">
                                    <input id="filterSearchButton" type="button" value="Update Search" onclick="searchFiltercustom()" class="search-filter-button" />
                ...
                <div class="footCrumb">
                    ...
                    <div class="tabPanelContent">
                        ...
                        @foreach($all_brand_sizes as $all)
                                ...
                                $url = str_replace('/','-',$url);
                                @endphp
                                @if(isset($all->tyre_brands))
                                <li><a href="{{route('brand/size')}}?brands={{isset($all->tyre_brands)?$all->tyre_brands->url:''}}&size={{$url}}&size_type={{$all->tyre_sizes->id}}">{{isset($all->tyre_brands)?$all->tyre_brands->name:''}} {{isset($all->tyre_sizes)?$all->tyre_sizes->name:''}}</a></li>
                                @endif
                            @endforeach
    ...
    <footer class="footer quicksales">
        <div class="wrapper">
            ...
            <section class="footerSection">
                ...
                <a href="{{url('page',['slug'=>'about-us'])}}">About Us</a>
                <a href="{{route('contact-us')}}">Contact Us</a>
                <a href="/corporate-advertising">Corporate Advertising</a>
                <a href="/site-map">Site Map</a>
                <a href="{{url('page',['slug'=>'terms-conditions'])}}">Terms and Conditions</a>
                <a href="{{route('dealer-signup')}}">Dealer Signup</a>
                <a href="{{url('page',['slug'=>'privacy'])}}">Privacy</a>
                <a href="{{route('fitment-locations')}}">Fitment Locations</a>
                <a href="{{route('offers/current-promotions')}}">Promotions</a>
...
function searchFiltercustom() {
   var group = $('.categories_list');
   values = -1; 
   array = [];
           group.each(function () {
           ...
           priceFrom = $('#SelectedPriceFrom').val();
           priceto = $('#SelectedPriceTo').val();           
       ...
       if(priceto!=null){
            ...
            if($('#SelectedHasPromotion').prop("checked")){
               $('#promotion').val('1');
            }
                    if($('#SelectedHasRunFlat').prop("checked")){
               $('#runflat').val('1');
            } 
