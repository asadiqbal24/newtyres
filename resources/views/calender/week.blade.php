...
<section class="content home">
            ...
            <div class="col-lg-9 col-md-9">
                <div class="card">
                    <div class="body">
                        <div class="row">
                            ...
                            <div class="col-md-8 text-center">
                               ...
                               <a href="{{route('admin.calender/list')}}" class="btn btn-raised btn-default">List</a>
                                ...
                                <a href="{{route('admin.calender/week')}}" class="btn btn-raised btn-primary">Week</a>
                        ...
                        <div class="col-lg-12 table-responsive" id="show_weekly_calender" style="display: block;">
                            <table class="table table-bordered table-striped">
                                <thead>
                                   <tr>
                                                                        <th width="5%"></th>
                                        @foreach($week_dates as $wkd)
                                        <th width="100px" style="text-align: center;" colspan="{{$bays->count()}}">{{$wkd}}</th>
                                        @endforeach
                                    </tr>
                                </thead>
                                 <tr>
                                            ...
                                            <td>{{date('h:ia',$start )}}</td>
                                             @foreach($week_dates as $wkd)
                                                ...
                                                @php $i = 0;$j = 0; @endphp
                                                        ...
                                                        @foreach($weekly_data as $k => $ap)

                                                            @if(($ap->from_date == $wkd) && ($bays[$t]->bay_name==$ap->bay) && (strtotime($ap->time_from) <= strtotime(date('H:i',$start ))) && (strtotime($ap->time_to) >= strtotime(date('H:i',$start ))))


                                                                <td onclick="editAppointment('{{$ap->id}}')" style="cursor: pointer;background-color: #ffff93;color: black !important;border-bottom: 0px;border-top: 0px !important;text-align: center;<?php if($ap->time_from==date('H:i',$start )) echo 'background-color: #f4a228;color: black !important;' ?> <?php if($ap->time_to==date('H:i',$start )) echo 'border-bottom: 1px solid;background-color: #ffff93;color: black !important;' ?>" width="50%" class="w_{{$bays[$t]->bay_name}} week_category_selection" data-time="{{date('H:i',$start )}}" data-date="{{$wkd}}">
                                                        ...
                                                        @endforeach
                                                         ...
                                                         @if($j==0)
                                                            <td width="50%" class="w_{{$bays[$t]->bay_name}} week_category_selection" data-time="{{date('H:i',$start )}}" data-date="{{$wkd}}"></td>
                                                         @endif  
  ...
  <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
      ...
      <path d="M2.678 11.894a1 1 0 0 1 .287.801 10.97 10.97 0 0 1-.398 2c1.395-.323 2.247-.697 2.634-.893a1 1 0 0 1 .71-.074A8.06 8.06 0 0 0 8 14c3.996 0 7-2.807 7-6 0-3.192-3.004-6-7-6S1 4.808 1 8c0 1.468.617 2.83 1.678 3.894zm-.493 3.905a21.682 21.682 0 0 1-.713.129c-.2.032-.352-.176-.273-.362a9.68 9.68 0 0 0 .244-.637l.003-.01c.248-.72.45-1.548.524-2.319C.743 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7-3.582 7-8 7a9.06 9.06 0 0 1-2.347-.306c-.52.263-1.639.742-3.468 1.105z"/>
                       ...
                       <div class="col-lg-12" id="show_list_calender" style="display: none;">
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <td>Day</td>
                                    <td>Date</td>
...
var weekly_data = {!! json_encode($weekly_data->toArray()) !!};   
var week_dates = {!! json_encode($week_dates) !!};   
