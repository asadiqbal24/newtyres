                    ...
                    <div class="body">
                        <div class="row">
                            ...
                            <div class="col-md-8 text-center">
                                ...
                                <a href="{{route('admin.calender/list')}}" class="btn btn-raised btn-primary">List</a>
                        ...
                        @endphp
                        @if(!empty($result))
                        <div class="col-lg-12" id="show_search_calender" style="display: block;">
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <div class="col-lg-12" id="show_list_calender" style="display: block;">
                                            <table class="table table-bordered table-striped">
                                                <thead>
                                                    <td>Day</td>
                                                    <td>Date</td>
