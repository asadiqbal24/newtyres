...
<ul class="sc-kxynE hVvTOh main-site-menu-items">
   ...
   <li>
      ...
      <ul>
         ...
         <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/customer-service-price-match-guarantee') }}">Price Match Guarantee</a>
         </li>
         <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/customer-service-same-day-next-day-offers') }}">Same Day / Next Day Offers</a>
         </li>
      </ul>
   </li>
   <li>
      ...
      <ul>
         <li>
            <a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/#') }}">Purchasing Tyres</a>
            <ul>
               <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/learn-more-purchasing-tyres-tyre-buying-guide') }}">Tyre Buying Guide</a>                                                
               </li>
            </ul>
            <ul>
               <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/learn-more-purchasing-tyres-tyre-size-guide') }}">Tyre Size Guide</a>                                                
               </li>
            </ul>
            <ul>
               <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/learn-more-purchasing-tyres-delivery-information') }}">Delivery Information</a>                                                
               </li>
            </ul>
            <ul>
               <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/whybuyonline') }}">Why Buy Online</a>                                                
               </li>
            </ul>
         </li>
         <li>
            <a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/#') }}">Fitting Tyres</a>
            <ul>
               <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/customer-service-fitting-and-balancing') }}">Fitting &amp; Balancing</a>                                                
               </li>
            </ul>
            <ul>
         ...
         <li>
            <a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/help') }}">Help</a>
            <ul>
               <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/learn-more-help-faq') }}">FAQ</a>                                                
               </li>
            </ul>
            <ul>
               <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/testimonials') }}">Testimonials</a>                                                
               </li>
            </ul>
            <ul>
               <li><a style="padding-top: 1.2pc;padding-bottom: 1.2pc;color:white" href="{{ url('/page/help-warranty') }}">Warranty &amp; Returns</a>                                                
               </li>
            </ul>
            <ul>
