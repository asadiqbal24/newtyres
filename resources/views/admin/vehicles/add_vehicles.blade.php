  ...
  <div class="container-fluid">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form method="post" action="{{route('admin.save.new.vehicle')}}" id="submit_vehicle_form">
        {{csrf_field()}}
        @if(isset($vehicle))
            ...
            <div class="row">
              <div class="col-md-3 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="register_no" class="form-control"  placeholder="Auto Generate">
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="derivative" required  class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-3 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="engine_cc" required  class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-4 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="paint_code" required  class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-4 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="key_code" required  class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-4 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="radio_code" required class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 input-group">
                <div class="form-line">
                  ...
                  <input type="date" name="date_manufactured" required  class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-6 input-group">
                <div class="form-line">
                  ...
                  <input type="date" name="date_reg" required  class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
            </div>
              ...
              <div class="col-md-3 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="tyre_size_front" required class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-3 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="tyre_size_back" required  class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-3 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="tyre_depth_front" required  class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-3 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="tyre_depth_back" required  class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
            </div>
          ...
          <div class="col-md-6" style="border-left: 1px solid;">
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane animated flipInX active" id="general">
                @include('admin.vehicles.general')
              </div>
