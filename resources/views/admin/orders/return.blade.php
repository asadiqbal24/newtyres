    ...
    <div class="card">
      <div class="card-body row">
        <div class="col-md-12">
          ...
          <a href="{{route('admin.new.order')}}" class="btn btn-success">Set Requested</a>
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-12 col-lg-12"> 
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#low_stock">Available Stock</a></li>
                                    
                                </ul>
                                
                                <!-- Tab panes -->
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane animated flipInX" id="required_items">
                                    ...
                                    <div role="tabpanel" class="tab-pane animated flipInX active" id="search">
                                      @include('admin.orders.search')                                                                         </div>
                                </div>
                            </div>
