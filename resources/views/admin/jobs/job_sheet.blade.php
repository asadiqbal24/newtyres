...
<section class="content home">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <a href="{{route('admin.add.jobsheets')}}" class="btn btn-success">New JobSheet</a>
                <a href="{{route('admin.document.archive')}}?type=jobsheets" class="btn btn-success">Archive</a>
      ...
      <div class="card-body">
        <form method="get" action="{{route('admin.jobsheets')}}">
          <div class="row">
            <div class="col-md-2">
                                ...
                                <option <?php if($e->status=='urgent') echo 'selected'; ?> value="urgent">Urgent</option>
                                  ...
                                  <td>
                                    ...
                                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#mobile{{ $e->id }}" data-backdrop="false"><i class="material-icons">phone</i></a>
                                      <a href="{{route('admin.jobsheet.view',['id'=>$e->id])}}" class="btn btn-primary"> Open </a>
                                      <a href="{{route('admin-jobsheet-delete',['id'=>$e->id])}}" class="btn btn-danger">Delete</a>
