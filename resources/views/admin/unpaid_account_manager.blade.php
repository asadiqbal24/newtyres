        ...
        <div class="row">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td>{{isset($c->customer)?$c->customer->account_number:''}}</td>
                <td>{{isset($c->customer)?$c->customer->company:''}}</td>
                <td>{{$c->credit_limit}}</td>
                <td>00.00</td>
                <td>00.00</td>
                <td>00.00</td>
                <td><a href="{{route('admin-manage-receipt-new',['id'=>$c->customer_id])}}" class="btn btn-primary"> Manage Receipt </a><a href="" class="btn btn-primary"> Statement </a><a href="" class="btn btn-primary">Edit</a></td>
              </tr>
              @endforeach()
            </tbody>
          </table>
