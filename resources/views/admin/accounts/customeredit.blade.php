...
@endif
        ...
        <form method="post" action="{{route('admin-customer-update')}}" id="submit_new_customer_form">
        {{csrf_field()}}
            ...
            <div class="row">
              <div class="col-md-3 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="account_number" class="form-control" value="{{isset($edit->customer)?$edit->customer->account_number:old('account_number')}}" placeholder="Auto Generate">
                </div>
              ...
              <div class="col-md-6 input-group">
                <div class="form-line">
                  <label>Company</label>
                  <input type="text" name="company" required value="{{isset($edit->customer)?$edit->customer->company:old('company')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-4 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="middle_name" required value="{{isset($edit->customer)?$edit->customer->middle_name:old('middle_name')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              <div class="col-md-4 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="last_name" required value="{{isset($edit->customer)?$edit->customer->last_name:old('last_name')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="house_no" required value="{{isset($edit->customer)?$edit->customer->house_no:old('house_no')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              <div class="col-md-4 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="postcode" required id="postal_code" value="{{isset($edit->customer)?$edit->customer->postal_code:old('postcode')}}" class="form-control">
              ...
              <div class="col-md-4 input-group">
                <div class="form-line">
                  <label>Road</label>
                  <input type="text" name="road" id="road" required value="{{isset($edit->customer)?$edit->customer->road:old('road')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-4 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="locality" required value="{{isset($edit->customer)?$edit->customer->locality:old('locality')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-4 input-group">
                <div class="form-line">
                  <label>Town</label>
                  <input type="text" name="town" id="town"  required value="{{isset($edit->customer)?$edit->customer->town:old('town')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-4 input-group">
                <div class="form-line">
                  <label>County</label>
                  <input type="text" name="county" id="county" required value="{{isset($edit->customer)?$edit->customer->county:old('county')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              </div>
            <div class="row">
              <div class="col-md-4 input-group">
                <div class="form-line">
                  ...
                  <input type="text" name="telephone" required value="{{isset($edit->customer)?$edit->customer->telephone:old('telephone')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-4 input-group">
                <div class="form-line">
                  <label>Mobile</label>
                  <input type="text" name="mobile" required value="{{isset($edit->customer)?$edit->customer->mobile:old('mobile')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
              ...
              <div class="col-md-4 input-group">
                <div class="form-line">
                  <label>Email</label>
                  <input type="email" name="email" required value="{{isset($edit->customer)?$edit->customer->email:old('email')}}" class="form-control">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
            </div>
