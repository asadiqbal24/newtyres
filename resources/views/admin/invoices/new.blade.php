    ...
    <div class="card">
      <div class="card-body row">
        ...
        <div class="col-md-12">
          ...
          <a href="#" data-toggle="modal" data-target="#copyModal" data-backdrop="false" class="btn btn-success">Payments</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">Add Payments</h4>
            </div>
