    ...
    <div class="card">
      <div class="card-body">
        <div class="row clearfix">
          ...
          <div class="col-md-6">
            <form method="post" id="form" action="{{route('admin.save-user-preferences')}}">
              {{csrf_field()}}
            <div class="row clearfix">  
            ...
            <div class="col-md-12 input-group">
              <div class="form-line">
                ...
                <input type="text" name="display_names" class="form-control" value="{{Auth::user()->name}}">
              </div>
                            ...
                            <div class="col-md-6 input-group">
                                <div class="form-line">
                                    <select class="form-control show-tick" name="home_screen" required>
                                        <option value="{{NULL}}">Home Screen</option>
                              ...
                              <div class="col-md-6 input-group">
                                <div class="form-line">
                                    <select class="form-control show-tick" name="interface_scaling" required>
                                        <option value="{{NULL}}">Interface Scaling</option>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content" style="background-color:cadetblue !important">
                    ...
                    <div class="modal-body">
                      <form method="post" action="{{route('admin.save-authentication')}}" id="authentication_form">
                        {{csrf_field()}}
                      <div class="row">
                        <div class="col-lg-12">
