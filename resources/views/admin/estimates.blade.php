...
<section class="content home">
  <div class="container-fluid">
    ...
    <div class="row clearfix">
      <div class="col-md-12">
        @if($estimates->count())
        <a href="{{route('admin.save-starting-no',['type'=>'estimate'])}}" class="btn btn-success">New Estimate</a>
        @else
        <a href="#" data-backdrop="false" data-toggle="modal" data-target="#copyModal" class="btn btn-success">New Estimate</a>
        @endif

        <a href="{{route('admin.document.archive')}}?type=estimate" class="btn btn-success">Archive</a>
            ...
            <tbody>
                ...
                <td>
                  ...
                  <!-- <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="change_status" data-id="{{$e->id}}" data-status="~" href="javascript:void(0);">~</a></li>
                      <li><a class="change_status" data-id="{{$e->id}}" data-status="auth-req" href="javascript:void(0);">Auth Req</a></li>
                      <li><a class="change_status" data-id="{{$e->id}}" data-status="complete" href="javascript:void(0);">Complete</a></li>
                      <li><a class="change_status" data-id="{{$e->id}}" data-status="mot" href="javascript:void(0);">MOT</a></li>
                      <li><a class="change_status" data-id="{{$e->id}}" data-status="service" href="javascript:void(0);">Service</a></li>
                      <li><a class="change_status" data-id="{{$e->id}}" data-status="urgent" href="javascript:void(0);">Urgent</a></li>
                    </ul>
                  </div> -->
              ...
              <select data-id="{{$e->id}}" name="status" class="form-control show-tick change_status">
                ...
                <td>
                  ...
                  <a href="{{route('admin.estimates.view',['id'=>$e->id])}}" class="btn btn-primary"> Open </a>
                  <a href="{{route('admin-estimate-delete',['id'=>$e->id])}}" class="btn btn-danger">Delete</a>
