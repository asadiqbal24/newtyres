...
<section class="content home">
  <div class="container-fluid">
    ...
    <div class="card">
      <div class="card-body row">
        <div class="col-md-12">
          ...
          <a href="#" data-toggle="modal" data-target="#copyModal" data-backdrop="false" class="btn btn-success btn-xs">Refunds</a>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        <form action="{{route('admin.save.invoice')}}?type=credit" method="post" id="submit_form">
          {{csrf_field()}}
          <div class="row">
            <div class="col-md-6">
              <div class="row">
