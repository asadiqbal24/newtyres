                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 input-group">
                            <div class="form-line">
                                <label class="col-md-12"><strong>Mot TEster</strong></label>
                                
                                <input type="radio" id="md_checkbox_1" class="chk-col-red" name="mot_tester" value="1" checked />
                                <label for="md_checkbox_1">Yes</label>
                                <br>
                                <input type="radio" id="md_checkbox_2" class="chk-col-red" name="mot_tester" value="0" />
