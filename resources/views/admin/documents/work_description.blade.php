                        ...
                        <div class="modal fade" id="copyModal" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form method="get" action="{{route('admin.doc.template.work_description_create')}}">
                                        {{csrf_field()}}
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.doc.template.work_description_edit',['id'=>$user->id])}}" type="button" class="btn btn-primary">Edit</a>
                                                <a href="{{route('admin.doc.template.work_description_delete',['id'=>$user->id])}}" type="button" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
