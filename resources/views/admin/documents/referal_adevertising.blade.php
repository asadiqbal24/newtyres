                        ...
                        <div class="modal fade" id="copyModal" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form method="get" action="{{route('admin.doc.template.referal_adevertising_create')}}">
                                        {{csrf_field()}}
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>     <a href="{{route('admin.doc.template.edit_referal_adevertising',['id'=>$user->id])}}" type="button" class="btn btn-primary">Edit</a>
                                            <a href="{{route('admin.doc.template.referal_adevertising_delete',['id'=>$user->id])}}" type="button" class="btn btn-danger">Delete</a>
                                       </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
