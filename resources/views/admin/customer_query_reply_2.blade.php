        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    <h2>Dashboard</h2>                    
                    <ul class="breadcrumb">                        
                        <li class="breadcrumb-item"><a href="{{route('admin.inqueries')}}">Tyre Not Found</a></li>
                    </ul>
                </div>            
            </div>
        </div>
                      ...
                      <h4>Reply</h4>                                            
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-12 col-sm-12 col-md-12 input-group">
                                     @php $value=''; @endphp
                                     @if(isset($queries))
                                       @php $value=$queries->comments; @endphp
                                     @else
                                                @php $value=''; @endphp
                                     @endif 
                                        <div class="form-line">
            ...
            <div class="col-lg-12">
                ...
                <div class="body">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-12">
                            <button type="button" class="btn btn-raised btn-success waves-effect">Send Message</button>
                        </div>
                    </div>                    
                </div>
                </div>
