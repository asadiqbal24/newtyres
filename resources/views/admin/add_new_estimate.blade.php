    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <form method="post" action="{{route('admin.save.new.estimate')}}" id="estmate_form">
                 {{csrf_field()}}   
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="registration_no" value="{{isset($estimate)?$estimate->registration_no:''}}" required class="form-control">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="derivative" required value="{{isset($estimate)?$estimate->derivative:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            ...
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label>Chassis</label>
                                    <input type="text" name="chassis" required value="{{isset($estimate)?$estimate->chassis:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="engine_cc" required value="{{isset($estimate)?$estimate->engine_cc:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="fuel_type" required value="{{isset($estimate)?$estimate->fuel_type:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                              ...
                              <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="engine_code" required value="{{isset($estimate)?$estimate->engine_code:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="engine_no" required value="{{isset($estimate)?$estimate->engine_no:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label>Colour</label>
                                    <input type="text" name="color" required value="{{isset($estimate)?$estimate->color:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="paint_code" required value="{{isset($estimate)?$estimate->paint_code:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                             <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="key_code" required value="{{isset($estimate)?$estimate->key_code:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="radio_code" required value="{{isset($estimate)?$estimate->radio_code:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label>Mileage</label>
                                    <input type="text" name="mileage" required value="{{isset($estimate)?$estimate->mileage:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="date" name="date_reg" required value="{{isset($estimate)?$estimate->date_reg:''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-5 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="acc_number" id="acc_number" required value="{{isset($estimate)?$estimate->acc_number:$request->account_number??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-5 input-group">
                                <div class="form-line">
                                    <label>Company</label>
                                    <input type="text" name="company" id="company" required value="{{isset($estimate)?$estimate->company:$request->company??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label>Name</label>
                                    <input type="text" name="name[]" id="first_name" required value="{{isset($name[0])?$name[0]:$request->first_name??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label></label>
                                    <input type="text" name="name[]" id="middle_name"  required value="{{isset($name[1])?$name[1]:$request->middle_name??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label></label>
                                    <input type="text" name="name[]" id="last_name"  required value="{{isset($name[2])?$name[2]:$request->last_name??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="house_no" id="house_no" required value="{{isset($estimate)?$estimate->house_no:$request->house_no??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="post_code" id="postal_code" required value="{{isset($estimate)?$estimate->post_code:$request->postcode??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            ...
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label>Road</label>
                                    <input type="text" name="road" id="road" required value="{{isset($estimate)?$estimate->road:$request->road??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            ...
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="locality" id="locality" required value="{{isset($estimate)?$estimate->locality:$request->locality??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label>Town</label>
                                    <input type="text" name="town" id="town" required value="{{isset($estimate)?$estimate->town:$request->town??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label>County</label>
                                    <input type="text" name="county" id="county" required value="{{isset($estimate)?$estimate->county:$request->county??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                             ...
                             <div class="col-md-3 input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" name="telephone" id="telephone" required value="{{isset($estimate)?$estimate->telephone:$request->telephone??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                            <div class="col-md-3 input-group">
                                <div class="form-line">
                                    <label>Mobile</label>
                                    <input type="text" name="mobile" id="mobile" required value="{{isset($estimate)?$estimate->mobile:$request->mobile??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-1 input-group">
                            @if(isset($estimate))
                                @if($estimate->is_email=='on')
                                    @php $checked = 'checked'; @endphp
                                @else
                                    @php $checked = ''; @endphp
                                @endif
                            @else                                    @php $checked = 'checked'; @endphp
                            ...
                            <div class="col-md-11 input-group">
                                <div class="form-line">
                                    <label></label>
                                    <input type="email" name="email" id="email" required value="{{isset($estimate)?$estimate->email:$request->email??''}}" class="form-control">
                                </div>
                                <span class="input-group-addon"> <i></i> </span>
                            </div>
...
<script>
 ...
 /** Search accordign to account number */
        $('#account_search').on('click', function(){
            ...
            $.ajax({
                type:'GET',
                url:'{{route("get_estimate_details")}}',
                data:{account:val },
