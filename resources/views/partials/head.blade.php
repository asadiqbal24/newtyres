...
<title>{{isset($app_name->value)?$app_name->value:''}} {{$page_title}}</title>
...
<link rel="stylesheet" href="{{asset('public/assets/css/hm-style.css')}}">
...
<link href="{{asset('public/assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css')}}" rel="stylesheet">
