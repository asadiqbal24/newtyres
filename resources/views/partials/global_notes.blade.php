<form method="post" action="{{route('admin.global-notes-save')}}">
  {{csrf_field()}}
  <div class="card">
    ...
    <div class="card-body notes_div" id="global_notes" style="display: none;">
      <textarea name="global_notes" rows="10" cols="37">{{$globalNotes->global_notes}}</textarea>
      
    </div>
    <div class="card-body notes_div" id="user_notes" style="display: none;">
      <textarea name="user_notes" rows="10" cols="37" >{{$globalNotes->user_notes}}</textarea>
    </div>
