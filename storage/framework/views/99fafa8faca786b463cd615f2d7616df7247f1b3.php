...
<link rel="stylesheet" href="<?php echo e(asset('public/assets/css/authentication.css')); ?>">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="card">
                    <h4 class="l-login">Login</h4>
                     <form action="<?php echo e(route('login.post')); ?>" id="frmSignIn" method="post">            
...
<script src="<?php echo e(asset('public/assets/bundles/mainscripts.bundle.js')); ?>"></script><!-- Custom Js --> 
