...
<table class="table table-bordered">
                                            ...
                                            <tr>
                                              ...
                                              <td><a href="<?php echo e(route('admin-adivsory-edit',['id'=>$a->id])); ?>" class="btn btn-success">Edit</a>
                                                <a href="<?php echo e(route('admin-adviorsy-delete',['id'=>$a->id])); ?>" class="btn btn-danger">Delete</a></td>
                                            </tr>
