                        ...
                        <div class="modal fade" id="copyModal" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form method="get" action="<?php echo e(route('admin.doc.template.referal_adevertising_create')); ?>">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>     <a href="<?php echo e(route('admin.doc.template.edit_referal_adevertising',['id'=>$user->id])); ?>" type="button" class="btn btn-primary">Edit</a>
                                            <a href="<?php echo e(route('admin.doc.template.referal_adevertising_delete',['id'=>$user->id])); ?>" type="button" class="btn btn-danger">Delete</a>
                                       </td>
                                        </tr>
