...
<?php $__env->startSection('estimates','active_tab'); ?>
<!-- Main Content -->
<section class="content home">
  <div class="container-fluid">
    ...
    <div class="row clearfix">
      <div class="col-md-12">
        <?php if($estimates->count()): ?>
        <a href="<?php echo e(route('admin.save-starting-no',['type'=>'estimate'])); ?>" class="btn btn-success">New Estimate</a>
        <?php else: ?>
        <a href="#" data-backdrop="false" data-toggle="modal" data-target="#copyModal" class="btn btn-success">New Estimate</a>
        <?php endif; ?>

        <a href="<?php echo e(route('admin.document.archive')); ?>?type=estimate" class="btn btn-success">Archive</a>
    ...
    <div class="card" style="display: none;" id="search_div">
      <div class="card-body">
        <form method="get" action="<?php echo e(route('admin.estimates')); ?>">
          <div class="row">
            <div class="col-md-2">
            ...
            <div class="modal-body">
              <div class="col-lg-12 col-sm-12 col-md-12 input-group">
                <div class="form-line">
                  ...
                  <input type="number" class="form-control" style="color:black !important" name="starting_from" id="starting_from">
                </div>
                <span class="input-group-addon"> <i></i> </span>
              </div>
            </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-primary waves-effect mr-1">SAVE</button>
        ...
        <div class="row">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <?php $models = unserialize($e->model); ?>
              <tr>
                <td><?php echo e($e->id); ?></td>
                <td><?php echo e($e->created_at); ?></td>
                <td><?php echo e($e->registration_no); ?></td>
                <td><?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($m); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
                <td></td>
                ...
                <td>
                  ...
                  <!-- <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="change_status" data-id="<?php echo e($e->id); ?>" data-status="~" href="javascript:void(0);">~</a></li>
                      <li><a class="change_status" data-id="<?php echo e($e->id); ?>" data-status="auth-req" href="javascript:void(0);">Auth Req</a></li>
                      <li><a class="change_status" data-id="<?php echo e($e->id); ?>" data-status="complete" href="javascript:void(0);">Complete</a></li>
                      <li><a class="change_status" data-id="<?php echo e($e->id); ?>" data-status="mot" href="javascript:void(0);">MOT</a></li>
                      <li><a class="change_status" data-id="<?php echo e($e->id); ?>" data-status="service" href="javascript:void(0);">Service</a></li>
                      <li><a class="change_status" data-id="<?php echo e($e->id); ?>" data-status="urgent" href="javascript:void(0);">Urgent</a></li>
                    </ul>
                  </div> -->

              <select data-id="<?php echo e($e->id); ?>" name="status" class="form-control show-tick change_status">
                ...
                <td>
                   <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#mobile<?php echo e($e->id); ?>" data-backdrop="false"><i class="material-icons">phone</i></a>
                  <a href="<?php echo e(route('admin.estimates.view',['id'=>$e->id])); ?>" class="btn btn-primary"> Open </a>
                  
                    <div class="modal fade" id="mobile<?php echo e($e->id); ?>" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form method="POST" id="vehicle_form" action="">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                            ...
                                            <input type="text" class="form-control" name="company" id="company" value="<?php echo e($e->company); ?>" style="color: black !important;">
                                        </div>

                                        <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                            <label class="mr-2">Telephone</label>
                                            <input type="text" class="form-control" name="telephone" id="telephone" value="<?php echo e($e->telephone); ?>" style="color: black !important;">
                                            <a href="tel:<?php echo e($e->telephone); ?>" class="float-right">
                                        ...
                                        <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                            ...
                                            <input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo e($e->telephone); ?>" style="color: black !important;">
                                            <a href="tel:<?php echo e($e->mobile); ?>" class="float-right">
                                                <svg xmlns="" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                                                    <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                                </svg>
                                            </a>
                                        ...
                                        <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email" value="<?php echo e($e->email); ?>" style="color: black !important;">
                                            <a href="mailto:<?php echo e($e->email); ?>" class="btn btn-primary btn-xs  float-right">Email</a>
                                        </div>
                                        ...
                                        <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                            ...
                                            <input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo e($e->mobile); ?>" style="color: black !important;">
                                            <a href="sms:<?php echo e($e->mobile); ?>">
                    ...
                    <a href="<?php echo e(route('admin-estimate-delete',['id'=>$e->id])); ?>" class="btn btn-danger" >Delete</a>
                </td>
              </tr>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body" style="display: none;" id="stock_order_info_div">
                    <a href="<?php echo e(route('admin.stock')); ?>">
...
<script type="text/javascript">
  $('.today').click(function(){
      ...
      window.location.href = '<?php echo e(route("admin.estimates")); ?>?today='+value;
