...
<?php $__env->startSection('suppliers','active_tab'); ?>
  ...
  <div class="container-fluid">
    ...
    <div class="card">
      <div class="card-body row">
        ...
        <div class="col-md-6">
          <a href="<?php echo e(route('admin.add.new.supplier')); ?>" class="btn btn-success">New Supplier</a>
          <a href="<?php echo e(route('admin.add.new.customer')); ?>" class="btn btn-success">Manage Orders</a>
          <a href="<?php echo e(route('admin.add.new.customer')); ?>" class="btn btn-success">Print</a>
        </div>
        <div class="col-md-2">
      ...
      <div class="card-body">
        <div class="row">
          <table class="table table-bordered">
            ...
            <tbody>
              <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td><?php echo e($c->account_number); ?></td>
                <td><?php echo e($c->company); ?></td>
                <?php $address = unserialize($c->address); ?>
                <td><?php $__currentLoopData = $address; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo e($adr); ?>,
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </td>
                <td>
                  
                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#mobile<?php echo e($c->id); ?>" data-backdrop="false"><i class="material-icons">phone</i></a>
                    <a href="<?php echo e(route('admin.edit.supplier',['id'=>$c->id])); ?>" class="btn btn-info">Open</a>
                    <a href="<?php echo e(route('admin-supplier-delete',['id'=>$c->id])); ?>" class="btn btn-danger">Delete</a>
