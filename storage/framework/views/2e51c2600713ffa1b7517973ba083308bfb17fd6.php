...
<link href="<?php echo e(asset('public/dist/huebee.min.css')); ?>" rel="stylesheet">
<link href="https://www.jqueryscript.net/css/jquerysctipttop.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootswatch/4.3.1/flatly/bootstrap.min.css">
    ...
    <div class="container-fluid">
        ...
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content" style="margin-top:15%;">
                    ...
                    <form method="post" action="<?php echo e(route('admin-document-template-setting-save')); ?>">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           <td><?php echo e($i++); ?></td>
                                            ...
                                            <td><?php echo e(ucwords($s->calender?'Active':'In-Active')); ?></td>
                                            <td><?php echo e(ucwords($s->estimates?'Active':'In-Active')); ?></td>
                                            <td><?php echo e(ucwords($s->jobsheet?'Active':'In-Active')); ?></td>
                                            <td><?php echo e(ucwords($s->invoice?'Active':'In-Active')); ?></td>

                                           <td><?php echo e($s->name); ?></td>
                                           <td><?php echo e($s->sort_order); ?></td>
                                           <td><?php echo e($s->background_color); ?></td>
                                           <td><?php echo e($s->text_color); ?></td>
                                           <td><a href="<?php echo e(route('admin-document-template-delete',['id'=>$s->id])); ?>" class="btn btn-danger">Delete</a></td>
...
<script src="<?php echo e(asset('public/colorPicker/jquery.minicolors.js')); ?>"></script>
