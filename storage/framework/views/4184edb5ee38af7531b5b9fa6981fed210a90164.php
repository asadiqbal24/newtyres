...
<?php $__env->startSection('job_sheets','active_tab'); ?>
<!-- Main Content -->
<section class="content home">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <a href="<?php echo e(route('admin.add.jobsheets')); ?>" class="btn btn-success">New JobSheet</a>
                <a href="<?php echo e(route('admin.document.archive')); ?>?type=jobsheets" class="btn btn-success">Archive</a>
      ...
      <div class="card-body">
        <form method="get" action="<?php echo e(route('admin.jobsheets')); ?>">
          <div class="row">
            <div class="col-md-2">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <table class="table table-bordered">
                          ...
                          <tbody>
                                <?php $__currentLoopData = $jobsheets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <select data-id="<?php echo e($e->id); ?>" name="status" class="form-control show-tick change_status">
                                ...
                                <option <?php if($e->status=='mot') echo 'selected'; ?> value="mot">Mot</option>                                <option <?php if($e->status=='service') echo 'selected'; ?> value="service">Service</option>
                                <option <?php if($e->status=='urgent') echo 'selected'; ?> value="urgent">Urgent</option>
                                  ...
                                  <td>
                                    ...
                                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#mobile<?php echo e($e->id); ?>" data-backdrop="false"><i class="material-icons">phone</i></a>
                                      <a href="<?php echo e(route('admin.jobsheet.view',['id'=>$e->id])); ?>" class="btn btn-primary"> Open </a>
                                          <a href="<?php echo e(route('admin-jobsheet-delete',['id'=>$e->id])); ?>" class="btn btn-danger">Delete</a>
