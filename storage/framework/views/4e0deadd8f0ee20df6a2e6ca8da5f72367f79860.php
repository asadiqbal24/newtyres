...
<section class="content home">
    <div class="container-fluid">
        ...
        <form method="post" action="<?php echo e(route('admin-new-predefined-save')); ?>">
...
<div class="row" style="margin:0px">
    <div class="col-lg-9">
      ...
      <div class="card-body">
        <?php echo $__env->make('admin.predefinedjob.tab', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      </div>
    </div>
    </div>
    
<div class="col-lg-3">
    <form method="post" action="<?php echo e(route('admin-extra-save')); ?>">
        <?php echo e(csrf_field()); ?>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                     ...
                                                     <div class="col-md-12">
                                                        <input type="number" value="<?php echo e(isset($sundaries)?$sundaries:''); ?>" name="sundaries" style="display:inline;width: 100%;" placeholder="Sundaries"> 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="number" value="<?php echo e(isset($lubricant)?$lubricant:''); ?>"  style="width:100%;" name="lubricant" placeholder="Lubricant">    
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                     <div class="col-md-12">
                                                      ...
                                                      <div class="col-md-12">     
                                                        <input type="number" value="<?php echo e(isset($paint_mat)?:''); ?>" name="paint_mat" style="    width: 100%;" placeholder="Paint & Mat">  
                                                    </div>
                                                 </div>
                                                 <div class="row">
                                                     <div class="col-md-12">
