...
<!--         <a href="" class="btn btn-danger float-right">Delete</a> -->
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form method="post" action="<?php echo e(route('admin.save.new.stock')); ?>" id="stock_form" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-3 input-group">
                  <div class="form-line">
                   ...
                   <input list="supplier_list" name="supplier" class="form-control" required value="<?php echo e(isset($stock)?$stock->supplier:old('supplier')); ?>" />
                        <datalist id="supplier_list">
                          <?php $__currentLoopData = $supplier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    <label>Category</label>
                        ...
                        <input list="categories" name="category" class="form-control" required value="<?php echo e(isset($stock)?$stock->category:old('category')); ?>" />
                        <datalist id="categories">
                          <?php $__currentLoopData = $fcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    <label>Sub</label>                      
                      <input list="csubategories" name="sub" class="form-control" required value="<?php echo e(isset($stock)?$stock->sub:old('sub')); ?>" />
                        <datalist id="csubategories">
                          <?php $__currentLoopData = $fsubcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($c); ?>">
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="manufacturer" required value="<?php echo e(isset($stock)?$stock->manufacturer:old('manufacturer')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
              </div>
              <div class="row">
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="part_number" required value="<?php echo e(isset($stock)?$stock->part_number:old('part_number')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="barcode" id="barcode_val" placeholder="Optional (up to 12 digits)" required value="<?php echo e(isset($stock)?$stock->barcode:old('barcode')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                <div class="col-md-3 input-group">
                ...
                <div class="col-md-4 input-group">
                    ...
                    <div id="barcode_img"><?php if(isset($stock)): ?> <?php echo $stock->barcode_img; ?> <?php endif; ?></div>
              ...
              <div class="row">
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="description" required value="<?php echo e(isset($stock)?$stock->description:old('description')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="cost_net" required value="<?php echo e(isset($stock)?$stock->cost_net:old('cost_net')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                <label>Select</label>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="trade_markup" required value="<?php echo e(isset($stock)?$stock->trade_markup:old('trade_markup')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                </div>
              <div class="row">
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="trade_net" required value="<?php echo e(isset($stock)?$stock->trade_net:old('trade_net')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                <label>TaxCode</label>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="retail_markup" required value="<?php echo e(isset($stock)?$stock->retail_markup:old('retail_markup')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="retail_net" required value="<?php echo e(isset($stock)?$stock->retail_net:old('retail_net')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
              ...
              <label>Guarantee</label>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="gurantee_custom" required value="<?php echo e(isset($stock)?$stock->gurantee_custom:old('gurantee_custom')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="location" required value="<?php echo e(isset($stock)?$stock->location:old('location')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                ...
                <div class="col-md-3 input-group">
                  <div class="form-line">
                    ...
                    <textarea type="text" name="keywords" required value="<?php echo e(isset($stock)?$stock->keywords:old('keywords')); ?>" class="form-control" style="height:35px !important; "><?php echo e(isset($stock)?$stock->keywords:old('keywords')); ?></textarea>
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-2 input-group">
                  <div class="form-line">
                    <label>Width</label>
                    <input type="text" name="width" required value="<?php echo e(isset($stock)?$stock->width:old('width')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                ...
                <div class="col-md-2 input-group">
                  <div class="form-line">
                    <label>Noise</label>
                    <input type="text" name="noise" required value="<?php echo e(isset($stock)?$stock->noise:old('noise')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
                ...
                <div class="col-md-2 input-group">
                  <div class="form-line">
                    <label>Level</label>
                    <input type="text" name="level" required value="<?php echo e(isset($stock)?$stock->level:old('level')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
            ...
            <div class="col-md-6" style="border-left: 1px solid;">
              ...
              <div class="row">
              <div class="col-md-12">
                <?php if(isset($stock_details)): ?>
                  <?php $check = 'checked'; ?>                  
                <?php else: ?>
                <?php if(old('track_item')=='on'): ?>
                  <?php $check = 'checked'; ?>
                <?php else: ?>
                  <?php $check = 'checked'; ?>
                <?php endif; ?> 
                ...
                <div class="demo-checkbox">
                  <input type="checkbox" value="1" id="md_checkbox_track_item" name="track_item" <?php echo e($check); ?> class="chk-col-red" />
            ...
            <div class="row">
              <?php if(isset($stock)): ?>
                      <?php $actual_stock = $stock->actual_stock_level; ?>
              <?php else: ?>
                 <?php if(old('actual_stock_level')): ?>
                      <?php $actual_stock = old('actual_stock_level'); ?>
                 <?php else: ?>
                      <?php $actual_stock = 0; ?>
                 <?php endif; ?> 
              <?php endif; ?>
              <div class="col-md-12 input-group">
                  <div class="form-line">
                    ...
                    <input type="text" name="actual_stock_level" id="actual_stock_level" required value="<?php echo e($actual_stock); ?>" class="form-control">
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 input-group">
                  <div class="form-line">
                    ...
                    <input type="number" name="low_stock_below" required value="<?php echo e(isset($stock)?$stock->low_stock_below:old('low_stock_below')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 input-group">
                  <div class="form-line">
                    ...
                    <input type="number" name="minimum_order_quantity" required value="<?php echo e(isset($stock)?$stock->minimum_order_quantity:old('minimum_order_quantity')); ?>" class="form-control">
                  </div>
                  <span class="input-group-addon"> <i></i> </span>
                </div>
            ...
            <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body notes_div" id="global_notes" style="display: block;">
                  <textarea name="global_notes" id="global_notes_input" rows="10" cols="60"><?php echo e(isset($stock)?$stock->info_notes:''); ?></textarea>
                ...
                <div class="card-body notes_div" id="user_notes" style="display: none;">
                  ...
                  <?php if(isset($stock)): ?>
                    <?php if($stock->image!=NULL): ?>
                      <img src="<?php echo e($stock->image); ?>" style="width: 100%;">
                    <?php endif; ?>
                  <?php endif; ?>
...
$('#generate_barcode').click(function(){
  ...
  $.ajax({
                type:'get',
                url:'<?php echo e(route("admin.generate_barcode")); ?>',
