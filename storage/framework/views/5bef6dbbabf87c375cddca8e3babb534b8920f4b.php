                        ...
                        <div class="modal fade" id="copyModal" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form method="get" action="<?php echo e(route('admin.doc.template.predefine_advisories_create')); ?>">
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th><?php echo e($i++); ?></th>
                                            <td><?php echo e($user->advisor_code); ?></td>
                                            <td><?php echo e($user->description); ?></td>
                                           

                                            <td>
                                                <a href="<?php echo e(route('admin.doc.template.predefine_advisories_edit',['id'=>$user->id])); ?>" type="button" class="btn btn-primary">Edit</a>
                                                <a href="<?php echo e(route('admin.doc.template.predefine_advisories_delete',['id'=>$user->id])); ?>" type="button" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
