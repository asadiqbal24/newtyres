  ...
  <div class="container-fluid">
    ...
    <div class="card">
      <div class="card-body row">
        ...
        <div class="col-md-9">
          <a href="<?php echo e(route('admin.add.new.supplier')); ?>" class="btn btn-success btn-xs">New Supplier</a>
          <a href="#" data-toggle="modal" data-target="#copyModal" data-backdrop="false" class="btn btn-success btn-xs">New Invoice</a>
          <a href="<?php echo e(route('admin.add.new.credit')); ?>" class="btn btn-success btn-xs">New Credit</a>
          <a href="<?php echo e(route('admin.expense.archive')); ?>" class="btn btn-success btn-xs">Archives</a>
          <a href="<?php echo e(route('admin.advanced_search')); ?>" class="btn btn-success btn-xs">Outstanding</a>
    ...
    <div class="modal fade" id="copyModal" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form method="get" action="<?php echo e(route('admin.new.invoice',['type'=>'new_invoice'])); ?>">
    ...
    <div class="modal fade" id="creditNote" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form method="get" action="<?php echo e(route('admin.new.expense.invoice',['type'=>'new_invoice'])); ?>">
            <input type="hidden" name="selected_id" id="selected_id">
            <div class="modal-header">
    ...
    <div class="modal fade" id="expense_categories" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <form method="get" action="<?php echo e(route('admin.new.credit_expense',['type'=>'new_invoice'])); ?>">
            <input type="hidden" name="selected_id" id="selected_id">
            <div class="modal-header">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <button data-toggle="modal" data-target="#creditNote" data-backdrop='false' class="btn btn-info invoice-select" data-id="<?php echo e($c->id); ?>">Invoice</button>
                  <button class="btn btn-info">Credit</button>                  
                  <button class="btn btn-info">Manage Receipts</button>
                  <a class="btn btn-info" href="<?php echo e(route('admin.edit.supplier',['id'=>$c->id])); ?>">Edit</a>
                </td>
              </tr>
