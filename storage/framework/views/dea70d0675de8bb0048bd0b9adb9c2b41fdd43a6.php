          ...
          <div class="col-md-9">
            ...
            <div class="row">
                ...
                <div role="tabpanel" class="tab-pane animated flipInX active" id="settings">
                  <?php echo $__env->make('admin.users.settings', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
                <div role="tabpanel" class="tab-pane animated flipInX" id="access_restrictions">
                  <?php echo $__env->make('admin.users.access_restrictions', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
                <div role="tabpanel" class="tab-pane animated flipInX" id="record_restrictions">
                  <?php echo $__env->make('admin.users.record_restrictions', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
