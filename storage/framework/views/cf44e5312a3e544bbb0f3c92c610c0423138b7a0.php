...
<section class="content home">
	<div class="container-fluid">
		...
		<div class="row clearfix" style="margin-bottom:30px;">
			...
			color: white;    text-align: center;" value="<?php echo e(isset($customer_account->customer)?$customer_account->customer->account_number:''); ?>">
			<input type="text" readonly name="id" style="background-color: #395f72;
			color: white; text-align: center;" value="<?php echo e(isset($customer_account->customer)?$customer_account->customer->company:''); ?>">
		</div>
				...
				<div class="col-lg-12">
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								<td><?php echo e($p->payment_id); ?> <div style="margin-top:10px;"><?php echo e($p->date); ?></div></td>
								<td style="text-align:center;"><?php echo e($p->balance); ?></td>
								<td><a href="#"  data-backdrop="false" data-toggle="modal" data-target="#editPayment" data-id='<?php echo e($p->id); ?>' data-amount='<?php echo e($p->amount); ?>' data-date='<?php echo e($p->date); ?>' data-description='<?php echo e($p->description); ?>' data-payment_id='<?php echo e($p->payment_id); ?>'  onclick="editForm(this)" class="btn btn-primary">Open</a></td>
							</tr>
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content">
				...
				<form method="post" action="<?php echo e(route('admin-payment-save')); ?>">
					...
					<input type="hidden" name="customer_id" value="<?php echo e($customer_account->customer_id); ?>">
	...
	<div class="modal fade" id="editPayment" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content">
				...
				<form method="post" action="<?php echo e(route('admin-payment-update')); ?>">
					<?php echo e(csrf_field()); ?>
