...
use Carbon\Carbon;
?>
<?php $__env->startSection('calender','active_tab'); ?>

<link rel="stylesheet" href="<?php echo e(asset('public/assets/plugins/fullcalendar/fullcalendar.css')); ?>">
...
<section class="content home">
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-12 col-md-6 col-sm-7">
                    <h2>Dashboard</h2>                    
                    <ul class="breadcrumb">                        
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.calender')); ?>">Calender</a></li>
                    </ul>
                </div>            
            </div>
        </div>
            ...
            <div class="col-lg-9 col-md-9">
                <div class="card">
                    <div class="body">
                        <div class="row">
                            <div class="col-md-4">
                             <form method="get" action="<?php echo e(route('admin.calender')); ?>">
                                 <div class="row">
                                <div class="col-md-10">
                                    <div class="form-line">
                            ...
                            <div class="col-md-8 text-center">
                                <a href="<?php echo e(route('admin.new.appointment')); ?>" class="btn btn-raised btn-success">New Appt</a>

                                <a href="<?php echo e(route('admin.calender/list')); ?>" class="btn btn-raised btn-default">List</a>
                                <a href="<?php echo e(route('admin.calender')); ?>" class="btn btn-raised btn-primary" >Day</a>
                                <a href="<?php echo e(route('admin.calender/week')); ?>" class="btn btn-raised btn-default">Week</a>
                                <a href="<?php echo e(route('admin.calender/monthly')); ?>" class="btn btn-raised btn-default">Month</a>
                        ...
                        <div class="row">
                              ...
                              <div class="col-md-4 input-group">
                                <div class="form-line">
                                    <select class="form-control show-tick" name="bay" required id="select_bay">
                                        <option value="<?php echo e(NULL); ?>">Select Bay</option>

                                        <?php $__currentLoopData = $bays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($b->bay_name); ?>"><?php echo e($b->bay_name); ?></option>
                            ...
                            <div class="col-lg-8">
                                <a class="btn btn-raised <?php if($date==date('Y-m-d',strtotime('-1 day'))): ?> btn-success <?php else: ?> btn-default <?php endif; ?>" href="<?php echo e(route('admin.calender')); ?>?date=<?php echo e(date('Y-m-d',strtotime('-1  day'))); ?>" >Yesterday</a>
                                <a class="btn btn-raised <?php if($date==date('Y-m-d')): ?> btn-success <?php else: ?> btn-default <?php endif; ?>" href="<?php echo e(route('admin.calender')); ?>?date=<?php echo e(date('Y-m-d')); ?>" id="change-view-day">Today</a>
                                <a class="btn btn-raised <?php if($date==date('Y-m-d',strtotime('+1 day'))): ?> btn-success <?php else: ?> btn-default <?php endif; ?>" href="<?php echo e(route('admin.calender')); ?>?date=<?php echo e(date('Y-m-d',strtotime('+1  day'))); ?>" >Tomorrow</a>                                    
                            </div>
                       ...
                       <div class="col-lg-12" id="show_day_calender" style="display: block;">
                            <table class="table table-bordered table-striped">
                                <tr>
                                    <th style="text-align: center;" colspan="<?php echo e($bays->count()+1); ?>"><?php echo e($date); ?></th>
                                </tr>
                                 <tr>
                                    <th width="5%"></th>
                                     <?php $__currentLoopData = $bays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <th style="text-align:center"><?php echo e($t->bay_name); ?></th>
                                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </tr>
                                 <tbody>
                                     @endphp
                                    ...
                                    $min = round(date("i") / 15) * 15;
                                     ...
                                     <?php while($start <= $end): ?>
                                        <tr>
                                            <td><?php echo e(date('h:ia',$start )); ?></td>
                                            <?php for($t=0;$t<$bays->count();$t++): ?>
                                                    <?php $prev_array = []; ?>                                                         
                                                <?php $i = 0;$j = 0; ?>
                                                <?php $__currentLoopData = $apt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $ap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                                    <?php if($bays[$t]->bay_name==$ap->bay && strtotime($ap->time_from) <= strtotime(date('H:i',$start )) && strtotime($ap->time_to) >= strtotime(date('H:i',$start ))): ?>
                                                        <td onclick="editAppointment('<?php echo e($ap->id); ?>')" style="cursor: pointer;background-color: #ffff93;color: black !important;border-bottom: 0px;border-top: 0px !important;text-align: center;<?php if($ap->time_from==date('H:i',$start )) echo 'background-color: #f4a228;color: black !important;' ?> <?php if($ap->time_to==date('H:i',$start )) echo 'border-bottom: 1px solid;background-color: #ffff93;color: black !important;' ?>" class="<?php echo e($bays[$t]->name); ?> category_selection" data-time="<?php echo e(date('H:i',$start )); ?>">
                                                            <?php if($ap->time_from==date('H:i',$start )): ?>
                                                                <?php echo e($ap->time_from); ?> ~ <?php echo e($ap->time_to); ?>

                                                            <?php else: ?> 
                                                                   
                                                                            <?php echo e($ap->status); ?> 
                                                                            <br>
                                                                            <?php echo e($ap->company_name); ?>

                                                                            <br>
                                                                            Tel:<?php echo e($ap->telephone); ?>

                                                                            <br>
                                                                            Mob:<?php echo e($ap->mobile); ?>

                                                                            <br>
                                                                            Reg:<?php echo e($ap->account_number); ?>

                                                                            <br>
                                                                            <?php echo e($ap->make); ?> <?php echo e($ap->model); ?>

                                                                             <br>
                                                                             <?php echo e($ap->description); ?>


                                                                   <?php array_push($prev_array,$ap->id) ?>
                                                                   <?php $apt->forget($k); ?>          
                                                            <?php endif; ?>
                                                        </td>
                                                        <?php $j = 1; ?>
                                                 ...
                                                 <?php if($j==0): ?>
                                                    <td class="<?php echo e($bays[$t]->name); ?> category_selection" data-time="<?php echo e(date('H:i',$start )); ?>"></td>
                                                 <?php endif; ?>   
                                            <?php endfor; ?>
                                        </tr>
                                 ...
                                 <tbody>
                                   ...
                                   <?php
                                    ...
                                    <tr>
                                       ...
                                       <td><?php echo e($value->bay); ?></td>
                                       <td><?php echo e($value->time_from); ?> ~ <?php echo e($value->time_to); ?></td>
                                       <td><?php echo e($diffInHours); ?> hours <?php echo e($diffInMinutes); ?> mins </td>
                                       <td><?php echo e($value->company); ?> Mob: <?php echo e($value->mobile); ?></td>
                                       <td><?php echo e($value->status); ?></td>
                                       <td>
                                       
                                       <a href="#" data-toggle="modal" data-target="#mobile<?php echo e($value->id); ?>" data-backdrop="false">
  ...
  <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                    ...
                                    <a href="<?php echo e(route('admin.edit.appointment', ['id' => $value->id ])); ?>" >open</a>
                                    
                                               <div class="modal fade" id="mobile<?php echo e($value->id); ?>" tabindex="-1" role="dialog">
                                                      ...
                                                      <form method="POST" id="vehicle_form" action="">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                                               ...
                                                               <input type="text" class="form-control" name="company" id="company" value="<?php echo e($value->company); ?>" style="color: black !important;">
                                                               
                                                            </div>
                                                            
                                                            <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                                                <label class="mr-2">Telephone</label>
                                                               <input type="text" class="form-control" name="telephone" id="telephone" value="<?php echo e($value->telephone); ?>" style="color: black !important;">
                                                                <a href="tel:<?php echo e($value->telephone); ?>" class="float-right">
                                                                                                                                            <svg xmlns="" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                                                                  <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                                                </svg>
                                                                        </a>
                                                            ...
                                                            <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                                               ...
                                                               <input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo e($value->mobile); ?>" style="color: black !important;">
                                                                <a href="tel:<?php echo e($value->mobile); ?>" class="float-right">
                                                                                                                                            <svg xmlns="" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                                                                  <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                                                                </svg>
                                                                </a>
                                                            ...
                                                            <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                                               ...
                                                               <input type="email" class="form-control" name="email" id="email" value="<?php echo e($value->email); ?>" style="color: black !important;">
                                                                <a href="mailto:<?php echo e($value->email); ?>" class="btn btn-primary btn-xs  float-right">Email</a>
                                                            </div>
                                                        ...
                                                        <div class="form-group" style="display:flex; flex-direction: row; justify-content: center; align-items: center; margin: 0px;">
                                                                <label class="mr-2">Send SMS</label>
                                                                  <input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo e($value->mobile); ?>" style="color: black !important;">
                                                               <a href="sms:<?php echo e($value->mobile); ?>">
...
<script src="<?php echo e(asset('public/assets/bundles/fullcalendarscripts.bundle.js')); ?>"></script>
...
var categories_s = <?php echo json_encode($categories_s->toArray()); ?>;           
var apt = <?php echo json_encode($apt->toArray()); ?>;   
...
<script type="text/javascript">
$('.calendar-container').calendar({
  date: new Date('<?php echo e($request->date); ?>') // today
});
</script>
...
$(document).on('click', '.day', function(){
            ...
            window.location.href="<?php echo e(route('admin.calender')); ?>?date="+d;             
    ...
    $('#select_bay').change(function(){
        if($(this).val()!=''){
            window.location.href="<?php echo e(route('admin.calender')); ?>?type="+$(this).val();
        }
...
<?php if($request->date): ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {        
        var date ='<?php echo e($request->date); ?>';
           /* date = new Date(date); */
...
<script type="text/javascript">
 ...
 $('#global_notes_input').on('keyup',function(){
    ...
    var data = $('#global_notes_input').val();
        $.ajax({
                type:'POST',
                url:'<?php echo e(route("calender_save_notes")); ?>',
                data:{_token: "<?php echo e(csrf_token()); ?>",data:data,type:'global'
                },
...
/* $('#user_notes_input').on('keyup',function(){
    ...
    var data = $('#user_notes_input').val();
        $.ajax({
                type:'POST',
                url:'<?php echo e(route("calender_save_notes")); ?>',
                data:{_token: "<?php echo e(csrf_token()); ?>",data:data,type:'user'
                },
                success: function( msg ) {
                }
            });
...
<script type="text/javascript">
    ...
    function editAppointment(id) {
        window.location.href = "<?php echo e(route('admin.edit.appointment')); ?>?id="+id
    }
