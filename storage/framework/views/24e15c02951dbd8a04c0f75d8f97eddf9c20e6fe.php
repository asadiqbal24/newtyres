...
<?php $__env->startSection('invoices','active_tab'); ?>
<!-- Main Content -->
<section class="content home">
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <a href="<?php echo e(route('admin.add-new-invoice')); ?>"  class="btn btn-success">New Invoice</a>
            <a href="<?php echo e(route('admin.document.archive')); ?>?type=invoices" class="btn btn-success">Archive</a>
        ...
        <div class="col-lg-9">
             <div class="card">
                <div class="card-body">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        
                        <tr>
                            <td><?php echo e($e->id); ?></td>
                            <td><?php echo e($e->created_at); ?></td>
                            <td><?php echo e($e->registration_no); ?></td>
                            <td><?php echo e($e->model); ?></td>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('admin.invoice.view-detail',['id'=>$e->id])); ?>" class="btn btn-primary"> Open </a>

                                <a href="<?php echo e(route('admin-invoice-delete',['id'=>$e->id])); ?>" class="btn btn-danger">Delete</a>
