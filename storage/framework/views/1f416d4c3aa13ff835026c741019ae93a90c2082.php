		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-12 mt-2">
					<img id="image_upload" src="<?php echo e(asset('public/images/theme/placeholder_general.jpg')); ?>" style="width: 100%;height: 150px;">
				</div>
			...
			<div class="col-md-4">
				...
				<div class="col-md-12 mt-2" style="padding: 0px !important">
					<img id="logo_1" src="<?php echo e(asset('public/images/theme/placeholder_general.jpg')); ?>" style="width: 65px;height: 65px;">
				</div>
			...
			<div class="col-md-4">
				...
				<div class="col-md-12 mt-2" style="padding: 0px !important">
					<img id="logo_2" src="<?php echo e(asset('public/images/theme/placeholder_general.jpg')); ?>" style="width: 65px;height: 65px;padding: 0px;">
				</div>
...
<button><i class="material-icons">add</i></button>
			...
			<div class="col-md-4">
				...
				<div class="col-md-12 mt-2" style="padding: 0px !important">
					<img id="logo_3" src="<?php echo e(asset('public/images/theme/placeholder_general.jpg')); ?>" style="width: 65px;height: 65px;padding: 0px;">
				</div>
