...
<div class="block-header">
       ...
       <form method="post" action="<?php echo e(route('admin-advisory-update')); ?>">
                                    ...
                                    <div class="row">
                                         <div class="col-md-12 input-group">
                                            <div class="form-line">
                                                ...
                                                <textarea type="text" cols="5" rows="5" name="description" required="" class="form-control"><?php echo e($edit->description); ?></textarea>
                                            </div>
