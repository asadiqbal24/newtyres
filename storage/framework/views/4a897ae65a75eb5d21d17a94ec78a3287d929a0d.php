                        ...
                        <div class="modal fade" id="copyModal" tabindex="-1" role="dialog">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form method="get" action="<?php echo e(route('admin.doc.template.termandcontion_create')); ?>">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.doc.template.termandcontion_edit',['id'=>$user->id])); ?>" type="button" class="btn btn-primary">Edit</a>
                                                <a href="<?php echo e(route('admin.doc.template.termandcontion_delete',['id'=>$user->id])); ?>" type="button" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
