...
<?php $__env->startSection('stock','active_tab'); ?>
  ...
  <div class="container-fluid">
    ...
    <div class="card">
      <div class="card-body row">
        ...
        <div class="col-md-6">
          <a href="<?php echo e(route('admin.add.new.stock')); ?>" class="btn btn-success">New Item</a>
          <a href="<?php echo e(route('admin.orders')); ?>" class="btn btn-success">Orders</a>
          <a href="<?php echo e(route('admin.stock')); ?>?type=low" class="btn btn-success">Low</a>
          <a href="<?php echo e(route('admin.stock')); ?>?type=reserved" class="btn btn-success">Reserved</a>
            ...
            <div class="row">
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo e($s->sub); ?></td>
                    <td><?php echo e($s->description); ?></td>
                    <td><?php echo e($s->barcode); ?></td>
                    <td><?php echo e($s->cost_net); ?></td>
                    <td><?php echo e($s->actual_stock_level); ?></td>
                    <td><?php echo e($s->low_stock_below); ?></td>
                    <td>
                      <a href="#" data-toggle="modal" data-target="#stock_info_modal" data-backdrop="false" class="btn btn-info">Info</a>
                      <a href="<?php echo e(route('admin.edit.stock',['id'=>$s->id])); ?>" class="btn btn-primary">Edit</a>
                      <a href="<?php echo e(route('admin-stock-delete',['id'=>$s->id])); ?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
